...
// Fetching the username from the current session to be displayed
if(isset($_SESSION['username'])) {
    $username = $_SESSION['username'];
    $query = "SELECT email, username, contract_num, Hospital FROM hospitalreps WHERE username = '$username'";
    $result = mysqli_query($conn, $query);
//Displaying the data of the logged in user
    if ($result && mysqli_num_rows($result) > 0) {
        $row = mysqli_fetch_assoc($result);
        $_SESSION['email'] = $row['email'];
        $_SESSION['username'] = $row['username'];
        $_SESSION['contract_num'] = $row['contract_num'];
                    ...
                    <div class="row m-l-0 m-r-0">
                        <div class="col-sm-4 bg-c-lite-green user-profile">
                            <div class="card-block text-center text-white">
                                ...
                                <p class="center"> Hospital Representative</p>
                        ...
                        <div class="col-sm-8">
                            <div class="card-block">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Contract Number</p>
                                        <h6 class="text-muted f-w-400"><?php echo isset($_SESSION['contract_num']) ? $_SESSION['contract_num'] : 'Guest'; ?></h6>
                                    </div>

                                    <div class="row">
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Hospital Name</p>
                                        <h6 class="text-muted f-w-400"><?php echo isset($_SESSION['Hospital']) ? $_SESSION['Hospital'] : 'Guest'; ?></h6>
                                    </div>
